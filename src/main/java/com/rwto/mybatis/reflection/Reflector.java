...
import com.rwto.mybatis.reflection.invoker.GetFieldInvoker;
import com.rwto.mybatis.reflection.invoker.Invoker;
import com.rwto.mybatis.reflection.invoker.MethodInvoker;
import com.rwto.mybatis.reflection.invoker.SetFieldInvoker;
import com.rwto.mybatis.reflection.property.PropertyNamer;
...
public class Reflector {
    ...
    // 线程安全的缓存
    private static final Map<Class<?>, com.rwto.mybatis.reflection.Reflector> REFLECTOR_MAP = new ConcurrentHashMap<>();
    ...
    public static Reflector forClass(Class<?> clazz) {
        if (classCacheEnabled) {
            ...
            com.rwto.mybatis.reflection.Reflector cached = REFLECTOR_MAP.get(clazz);
            if (cached == null) {
            ...
            return new com.rwto.mybatis.reflection.Reflector(clazz);
        }
    }
