...
public class XMLStatementBuilder extends BaseBuilder {
    ...
    public void parseStatementNode() {
        ...
        MappedStatement mappedStatement = MappedStatement.builder().configuration(configuration).id(currentNamespace + "." + id).sqlCommandType(sqlCommandType).sqlSource(sqlSource).resultType(resultTypeClass).build();
        // 添加解析 SQL
